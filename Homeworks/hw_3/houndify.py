...
class TextHoundClient(_BaseHoundClient):
    ...
    def query(self, query):
      ...
      http_conn = http.client.HTTPSConnection(self.hostname)
      http_conn.request('GET', TEXT_ENDPOINT + '?query=' + urllib.parse.quote(query), headers = headers)
